...
const Signup: React.FC = () => {
  ...
  return (
    <main className="w-full min-h-screen flex flex-col justify-start items-center bg-bodyPurple pb-[100px]">
      ...
      <section className="w-full h-full flex justify-between items-center pl-[100px] mt-[50px]">
        <AuthWrapper>
          <section className="w-full flex flex-col justify-start items-center">
            ...
            <section className="w-full flex flex-col justify-start items-center mt-[35px] mb-[80px]">
              <section className="flex items-start justify-start">
                <input type="checkbox" name="" id="" className="mr-[10px] cursor-pointer" />
                <span className="mb-[20px]">
                  You acknowledge that you have read and agreed to our
                  <Link href={"/"}>
                    <span className="text-[#9747FF] mx-[5px]">Terms of service</span>
                  </Link>
                  and our
                  <Link href={"/"}>
                    <span className="text-[#9747FF] mx-[5px]">Privacy Policy</span>
                  </Link>
                </span>
              </section>
